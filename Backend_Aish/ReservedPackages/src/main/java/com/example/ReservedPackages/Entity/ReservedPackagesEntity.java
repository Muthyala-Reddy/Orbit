package com.example.ReservedPackages.Entity;
...
public class ReservedPackagesEntity {
    @Column(name ="p_id  ")
    private Integer pId;
    @Column(name =" v_id  ")
    private Integer  vId;
    ...
    public ReservedPackagesEntity(String packageStandard, Integer pId, Integer staffId, Integer noOfCustomers, Integer code, Integer vId) {
        this.packageStandard = packageStandard;
        this.pId = pId;
        this.staffId = staffId;
        this.noOfCustomers = noOfCustomers;
